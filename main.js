...
i++
 ...
 while(i < positiveNumbers.length){
  ...
  // Challenge 4 Code
  i = 0 
  evenNum = mixedSignNumbers.filter((num) => num % 2 === 0);
  ...
  let emptyArray = [];
  // Challenge 8 Code
emptyArray.push("Study", "Code",)
emptyArray.unshift("Every", "Day")
console.log(emptyArray)
  ...
  //This is very similar to string building; create a new array,
  ...
  // Challenge 10 Code
  // 
  let students10 = myArray.splice(3,8)
  let i10=0
  ...
  let newArray = students2.slice(3,10);
 ...
 console.log(newArray)
  ...
  //Now console.log both the primaries and secondaries arrays, noting that 
  //.concat does NOT mutate the original arrays.
  // Challenge 15 Code


  let A = myArray.concat(dinosaurs3)
  console.log(myArray)
  console.log(dinosaurs3)
  console.log(myArray.concat(dinosaurs3))
